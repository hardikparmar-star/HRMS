import { a3 as commonjsGlobal, R as getDefaultExportFromCjs, r as reactExports, V as React, W as jsxRuntimeExports } from "./server-CRHjjnr4.js";
import { A as AppShell, C as CalendarDays, W as Wallet } from "./AppShell-DGymYcXL.js";
import { u as useQuery } from "./useQuery-CLRXpZSF.js";
import { q as clsx, s as supabase } from "./router-DKrS3J_0.js";
import { U as Users, C as Clock } from "./users-BlVlNvSK.js";
import "node:async_hooks";
import "node:stream/web";
import "node:stream";
import "./button-D2gbqy69.js";
var isArray_1;
...
function Stat({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border bg-card p-5 shadow-card", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `inline-flex size-9 items-center justify-center rounded-xl ${accent}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "size-4" }) })
    ] }),
...
function Dashboard() {
  const {
    ...
    queryFn: async () => {
      ...
      const [emp, att, lv, pay] = await Promise.all([supabase.from("employees").select("id, department", {
        count: "exact"
      }), supabase.from("attendance").select("id, status", {
        count: "exact"
      }).eq("date", today), supabase.from("leaves").select("id", {
        count: "exact"
      }).eq("status", "pending"), supabase.from("payslips").select("net_pay")]);
      const deptMap = {};
      (emp.data ?? []).forEach((e) => {
        const d = e.department || "Unassigned";
        deptMap[d] = (deptMap[d] ?? 0) + 1;
      });
      const dept = Object.entries(deptMap).map(([name, value]) => ({
        name,
        value
      }));
      const totalNet = (pay.data ?? []).reduce((s2, p) => s2 + Number(p.net_pay), 0);
      return {
        employees: emp.count ?? 0,
        present: (att.data ?? []).filter((a2) => a2.status === "present").length,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Overview of your organization at a glance." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-4 md:grid-cols-2 lg:grid-cols-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { icon: Users, label: "Total Employees", value: data?.employees ?? 0, accent: "bg-primary/10 text-primary" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { icon: Clock, label: "Present Today", value: data?.present ?? 0, accent: "bg-success/10 text-success" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { icon: CalendarDays, label: "Pending Leaves", value: data?.pendingLeaves ?? 0, accent: "bg-warning/10 text-warning" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { icon: Wallet, label: "Payroll YTD", value: `₹${(data?.totalNet ?? 0).toLocaleString("en-IN")}`, accent: "bg-accent text-accent-foreground" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-4 lg:grid-cols-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border bg-card p-5 shadow-card lg:col-span-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold", children: "Hiring trend" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 h-64", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(BarChart, { data: trend, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CartesianGrid, { strokeDasharray: "3 3", stroke: "oklch(0.92 0.008 260)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(XAxis, { dataKey: "month", stroke: "oklch(0.5 0.02 260)", fontSize: 12 }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(YAxis, { stroke: "oklch(0.5 0.02 260)", fontSize: 12 }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { contentStyle: {
            borderRadius: 12,
            border: "1px solid oklch(0.92 0.008 260)"
          } }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { dataKey: "hires", fill: "oklch(0.52 0.18 265)", radius: [8, 8, 0, 0] })
        ] }) }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border bg-card p-5 shadow-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold", children: "By department" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 h-64", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(PieChart, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Pie, { data: data?.dept ?? [], dataKey: "value", nameKey: "name", innerRadius: 50, outerRadius: 80, paddingAngle: 3, children: (data?.dept ?? []).map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Cell, { fill: colors[i % colors.length] }, i)) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, {})
        ] }) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2 space-y-1 text-sm", children: [
          (data?.dept ?? []).slice(0, 5).map((d, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: d.value })
          ] }, d.name)),
          (!data?.dept || data.dept.length === 0) && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "No employees yet." })
        ] })
      ] })
    ] })
  ] });
