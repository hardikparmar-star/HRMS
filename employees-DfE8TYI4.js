...
import { a as useQueryClient, u as useAuth, t as toast } from "./router-DKrS3J_0.js";
import { B as Button } from "./button-D2gbqy69.js";
import { L as Label, I as Input } from "./label-C110OV--.js";
import { D as Dialog, a as DialogTrigger, P as Plus, b as DialogContent, c as DialogHeader, d as DialogTitle, e as DialogFooter } from "./dialog-DQOeg1Au.js";
...
function EmployeesPage() {
  ...
  const [localEmployees, setLocalEmployees] = reactExports.useState(() => {
    try {
      const saved = localStorage.getItem("pulse_employees");
  ...
  reactExports.useEffect(() => {
    localStorage.setItem("pulse_employees", JSON.stringify(localEmployees));
  }, [localEmployees]);
  ...
  const onSubmit = async (e) => {
    ...
    const obj = {
      ...
      employee_code: "EMP" + Math.floor(Math.random() * 1e4)
    };
    fd.forEach((v, k) => {
      obj[k] = v === "" ? null : v;
    });
    ["basic_salary", "hra", "conveyance", "medical", "special_allowance"].forEach((k) => {
      obj[k] = Number(obj[k] ?? 0);
    });
    setLocalEmployees((prev) => [obj, ...prev]);
  ...
  const downloadTemplate = () => {
    const ws = utils.json_to_sheet([{
      ...
      conveyance: 5e3,
      medical: 2e3,
      special_allowance: 1e4
    }]);
    const wb = utils.book_new();
    utils.book_append_sheet(wb, ws, "Employees");
    writeFileSync(wb, "employees_template.xlsx");
  };
      ...
      try {
        ...
        for (const row of data) {
          if (!row.full_name || !row.email) {
            errorCount++;
            lastError = "Missing full_name or email";
            continue;
          }
          const obj = {
            id: crypto.randomUUID(),
            employee_code: row.employee_code || "EMP" + Math.floor(Math.random() * 1e4),
        ...
        if (errorCount > 0) {
          toast.error(`Imported ${successCount}. ${errorCount} failed. Missing name or email.`);
        } else {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center justify-between gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-3xl font-bold", children: "Employees" }),
      ...
      isAdmin && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "file", accept: ".xlsx, .xls, .csv", className: "hidden", ref: fileRef, onChange: handleImport }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", className: "gap-2", onClick: downloadTemplate, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Download, { className: "size-4" }),
          " Template"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", className: "gap-2", onClick: () => fileRef.current?.click(), disabled: busy, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Dialog, { open, onOpenChange: setOpen, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "max-h-[85vh] max-w-2xl overflow-y-auto", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { children: "New employee" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit, className: "grid grid-cols-2 gap-4", children: [
              [["full_name", "Full name", true], ["email", "Email", true], ["phone", "Phone"], ["department", "Department"], ["designation", "Designation"], ["joining_date", "Joining date", false, "date"], ["pan_number", "PAN"], ["aadhaar_number", "Aadhaar"], ["uan_number", "UAN"], ["reporting_manager", "Reporting manager"], ["bank_name", "Bank name"], ["bank_account", "Account #"], ["bank_ifsc", "IFSC"], ["basic_salary", "Basic", false, "number"], ["hra", "HRA", false, "number"], ["conveyance", "Conveyance", false, "number"], ["medical", "Medical", false, "number"], ["special_allowance", "Special allowance", false, "number"]].map(([name, label, req, type]) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: name === "full_name" || name === "email" ? "col-span-2" : "", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: name, children: label }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { id: name, name, type: type || "text", required: Boolean(req) })
              ] }, name)),
              /* @__PURE__ */ jsxRuntimeExports.jsx(DialogFooter, { className: "col-span-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { type: "submit", children: "Save employee" }) })
            ] })
          ] })
        ] })
      ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border bg-card shadow-card", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 border-b p-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { value: q, onChange: (e) => setQ(e.target.value), placeholder: "Search name, email, code, department", className: "border-0 shadow-none focus-visible:ring-0" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(TableHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { children: "Designation" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "text-right", children: "CTC (Basic)" }),
          isAdmin && /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, {})
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(TableBody, { children: [
          filtered.map((e) => /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "font-mono text-xs", children: e.employee_code }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "font-medium", children: e.full_name }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-muted-foreground", children: e.email }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: e.department }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: e.designation }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(TableCell, { className: "text-right", children: [
              "₹",
              Number(e.basic_salary).toLocaleString("en-IN")
            ] }),
            isAdmin && /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "icon", variant: "ghost", onClick: () => remove(e.id), children: /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { className: "size-4 text-destructive" }) }) })
          ] }, e.id)),
          filtered.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(TableRow, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { colSpan: isAdmin ? 7 : 6, className: "py-12 text-center text-muted-foreground", children: "No employees found." }) })
        ] })
      ] })
    ] })
  ] });
}
const SplitComponent = () => /* @__PURE__ */ jsxRuntimeExports.jsx(AppShell, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(EmployeesPage, {}) });
export {
